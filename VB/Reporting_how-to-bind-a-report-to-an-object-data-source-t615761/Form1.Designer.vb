Namespace ObjectDataSource
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			toolTipItem14.Text = "Invoke the Magnifier tool." & vbCrLf & vbCrLf & "Clicking once on a document zooms it so that a sing" & "le page becomes entirely visible, while clicking another time zooms it to 100% o" & "f the normal size."
			...
			toolTipItem24.Text = "Insert ghosted text or image behind the content of a page." & vbCrLf & vbCrLf & "This is often used " & "to indicate that a document is to be treated specially."
			...
			toolTipItem30.Text = "Select the margin sizes for the entire document." & vbCrLf & vbCrLf & "To apply specific margin size" & "s to the document, click Custom Margins."
